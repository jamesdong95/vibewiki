...
REQUIRED_HTML_MARKERS = (
    ...
    "function exportWiki",
    'renderMarkdown',
    'Supports JS/JSX/TS/TSX in local repositories.',
    ...
    'id="ask-remember"',
    'id="ask-thread"',
    'id="ask-feedback-save"',
    'id="intent-flow-list"',
    'id="intent-add-flow"',
    'id="intent-template-select"',
    'id="intent-template-save"',
    'function renderIntentEditor',
    'function collectIntentFlows',
    '/api/intent/templates',
    'Save discussion locally',
    '/api/discussions',
    'stale_confirmed',
    'MAX_IMPORT_BYTES',
